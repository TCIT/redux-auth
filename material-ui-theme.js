...
/***/ function(module, exports, __webpack_require__) {
	...
	var _favorite = __webpack_require__(145);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EmailSignInSuccessModal = __webpack_require__(126);

	var _EmailSignInSuccessModal2 = _interopRequireDefault(_EmailSignInSuccessModal);

	var _EmailSignInErrorModal = __webpack_require__(125);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _delete = __webpack_require__(144);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _send = __webpack_require__(46);
	...
	var ErrorList = function (_React$Component) {
	  ...
	  _createClass(ErrorList, [{
	    ...
	    value: function renderErrorList() {
	      ...
	      if (errorCount > 0) {
	        // pluralize message
	        var errorWord = errorCount === 1 ? "el siguiente error" : "los siguientes errores";
	        ...
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(_error2.default, {
	            ...
	            style: {
	              ...
	              top: 3 },
	            color: Colors.red500 }),
	          " Por favor revisa los valores de los campos e intenta de nuevo"
	        );
	      }
	    }
	  }, {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _extends({}, this.props, {
	          ...
	          title: "Error de cierre de sesi\xF3n",
	          closeAction: _ui.hideSignOutErrorModal }),
	        _react2.default.createElement(
	          "p",
	          null,
	          "Ocurri\xF3 un error en el servidor intentando cerrar la sesi\xF3n. La informaci\xF3n de tu cuenta ha sido borrada de este navegador, pero recomendamos iniciar sesi\xF3n y cerrarla de nuevo para resolver cualquier problema."
	        )
	      );
	    }
	  }]);
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _extends({}, this.props, {
	          ...
	          title: "Hasta pronto!" }),
	        "Tu sesi\xF3n se ha cerrado exitosamente."
	      );
	    }
	  }]);
